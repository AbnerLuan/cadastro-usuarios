	...
	<div class="pcoded-inner-navbar main-menu">
		...
		<ul class="pcoded-item pcoded-left-item">
			<li class="active"><a
				...
				class="waves-effect waves-dark" style="margin-top: 5px"> <span
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<ul class="pcoded-submenu">
					...
					<c:if test="${isAdmin}">
						<li class=" "><a
							href="<%=request.getContextPath()%>/ServletUsuarioController?acao=listaUser"
							class="waves-effect waves-dark"> <span class="pcoded-micon"><i
		...
		<ul class="pcoded-item pcoded-left-item">
			<li><a
				...
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
					...
					data-i18n="nav.form-components.main">Relatório de Usuarios</span> <span
					class="pcoded-mcaret"></span>
			</a></li>
			<li><a
				...
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
						class="ti-layers"></i><b>FC</b></span> <span class="pcoded-mtext"
					data-i18n="nav.form-components.main">Grafico de Salários</span> <span
					class="pcoded-mcaret"></span>
			</a></li>
		</ul>

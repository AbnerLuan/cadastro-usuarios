...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="Sistema para cadastro de Usuários." />
      <meta name="keywords" content="cadastro Usuários, cadastro de Usuários, controle de Usuários" />
      <meta name="author" content="Abner Luan" />
      <!-- Favicon icon -->
